package com.example.minh.myapplication.Database;
...
public class Createdatabase extends SQLiteOpenHelper {
    ...
    public void onCreate(SQLiteDatabase sqLiteDatabase) {
        String tbNHANVIEN="CREATE TABLE " + TB_NHANVIEN +"("+TB_NHANVIEN_MANV + " INTEGER PRIMARY KEY AUTOINCREMENT ,"+TB_NHANVIEN_CMND +" INTEGER, "+TB_NHANVIEN_GIOITINH+ " TEXT, "+TB_NHANVIEN_MATKHAU +" TEXT, "+TB_NHANVIEN_NGAYSINH +" TEXT ,"+TB_NHANVIEN_TENDN+" TEXT )";
        ...
        String tbMONAN="CREATE TABLE " +TB_MONAN +" (" +TB_MONAN_MAMON +" INTEGER PRIMARY KEY AUTOINCREMENT,"+TB_MONAN_GIATIEN +" TEXT"+TB_MONAN_MALOAI +"INTEGER" +TB_MONAN_TENMONAN + "TEXT)";
        String tbLOAIMON ="CREATE TABLE " +TB_LOAIMONAN +" ("+TB_LOAIMONAN_MALOAI +" INTEGER PRIMARY KEY AUTOINCREMENT,"+TB_LOAIMONAN_TENLOAI +" TEXT )";
        ...
        String tbCHITIETGOIMON="CREATE TABLE "+TB_CHITIETGOIMON +" ("+TB_CHITIETGOIMON_MAGOIMON +" INTEGER," + TB_CHITIETGOIMON_MAMONAN +" INTEGER," +TB_CHITIETGOIMON_SOLUONG +" INTEGER ," +"PRIMARY KEY("+TB_CHITIETGOIMON_MAGOIMON+","+TB_CHITIETGOIMON_MAMONAN+"))";
